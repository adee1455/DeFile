...
const content = [
  ...
  },
  {
    ...
    description:
      "Authorized users can easily unlock and download files after the specified access period. DeFile ensures that only users with the correct permissions can access your data, providing a secure way to share and manage sensitive information. This ensures that your files remain protected until the exact moment they are needed.",
    content: (
