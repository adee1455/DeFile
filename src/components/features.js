...
export default function Features() {
  return (
    <div className='my-10 '>
        ...
        <BackgroundGradientDemo title={'Customizable Access Periods'} desc={'Set specific access periods for your documents, ensuring only authorized users can view them during designated times.'} img={'/time.svg'} height={170} width={170} classs={'p-3 object-contain '}/>
